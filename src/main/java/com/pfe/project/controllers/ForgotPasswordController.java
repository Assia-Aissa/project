...
import com.pfe.project.dao.ForgotPasswordRepository;
import com.pfe.project.dao.UserDao;
import com.pfe.project.dto.ChangePassword;
import com.pfe.project.dto.MailBody;
import com.pfe.project.modeles.ForgotPassword;
import com.pfe.project.modeles.User;
import com.pfe.project.service.EmailService;
...
public class ForgotPasswordController {
        ...
        public ResponseEntity<String> verifyEmail(@PathVariable String email) {
            ...
            if(user == null){
                throw new UsernameNotFoundException("Please provide a valid email!" + email);
            }
